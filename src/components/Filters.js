    ...
    <div className="w-full h-12 border-2 border-gray-100 rounded-lg flex items-center justify-between relative">
      ...
      <div className="flex mr-7">
        ...
        <label className="relative flex items-center justify-center ">
          ...
          <select
            className="rounded bg-gray-200 text-base pl-0.5 pr-10 pu-1.5 leading-4 capitalize focus:*:qaoutline-0"
            onClick={handleSort}
            name="sortby"
          >
          ...
          <img
            src={selectIcon}
            className="w-[1rem] absolute right-0.5 top-1 h-auto"
          />
        </label>
        <button className="w-[2rem] ml-4 hover:scale-110 transition-all transition-ease relative right-0 top-0"
