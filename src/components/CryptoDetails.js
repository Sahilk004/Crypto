import React, { useContext, useEffect, useLayoutEffect, useState,props } from "react";
...
const CryptoDetails = () => {
  let { coinId } = useParams(); //jo link pe h vo niche bhi laane ke liye
  let navigate = useNavigate(); //popup ko close krne ke liye
  ...
  return ReactDOM.createPortal(
    //Portal piche ka same rhne deta h bs popup ko change kr skte h
    <div
      className="fixed top-0 w-full h-full bg-gray-200 bg-opacity-30 first-letter: backdrop-blur-sm flex items-center justify-center font-nunito text-white"
      onClick={close}
    >
      <div
        className="w-[65%] h-[75%] bg-gray-300 bg-opacity-75 rounded-lg relative"
              ...
              <div className="flex w-full mt-4 justify-between">
                ...
                <div className="flex flex-col content-start">
                  ...
                  <div className="flex justify-between">
                    <div>
                      <span
                        className={`text-sm px-1 ml-2 my-1
                          font-medium flex items-center rounded uppercase bg-opacity-25 bg-green text-green
                      `}
                      >
            ...
            <div className="flex flex-col w-[55%] h-full pl-3 ">
              ...
              <div className="flex flex-col mt-4 ">
                          <h3 className="text-white py-1">
                            <span className="text-gray-100 capitalize mr-1">Market Cap Rank: </span> {data.market_cap_rank}
                          </h3>
  ...
  >
    ...
    <path fill="rgba(0, 0, 0, 0)" d="M0 0h1024v1024H0z" />
                ...
                {
                  data.links.subreddit_url &&  <a className="text-lg px-1" target={"_blank"} rel="noreferrer" href={data.links.subreddit_url}>
                     <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
  ...
  >
    ...
    <path fill="rgba(0, 0, 0, 0)" d="M0 0h24v24H0z" />
               ...
               {
                data.links.facebook_username && <a className="text-lg px-1" target={"_blank"} rel="noreferrer" href={`https://facebook.com${data.links.facebook_username}`}>
                  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
  ...
  >
    ...
    document.getElementById("model") //public mien index.html mien model ko bulane ke liye mtlb pop up bnaya
  );
};
