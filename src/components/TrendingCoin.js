  ...
  return (
    ...
    >
        ...
        <h3 className='text-base flex items-center my-0.5'>
            ...
            <img src={data.small} className='w-[1.5rem] h-[1.5rem] mx-1.5 rounded-full'/>
        </h3>
            ...
            <img src={data.large} className='w-[35%] h-auto mx-1.5 rounded-full absolute top-2/4 -right-12 -translate-y-2/4'/>
        </>
