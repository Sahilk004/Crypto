        ...
        <div className='flex items-center'>
            ...
            <ul  className='flex items-center justify-end text-sm'>
                ...
                }
                {
                    page !== TotalNumber ?
                    (<li>
                        <button onClick={()=>setPage(TotalNumber)} className='outline-0 hover:text-cyan rounded-full w-8 h-8 flex items-center justify-center bg-gray-200 mx-1.5'>{TotalNumber}</button>
                        </li>
                    )
                    :null
                }
                <li>
                     <button className='outline-0 hover:text-cyan w-8' onClick={next}><img className='w-full h-auto' src={paginationArrow}/></button>
                </li>
            </ul>
        </div>
      )
